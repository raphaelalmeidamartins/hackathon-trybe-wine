...
function MenuHambugerIconNegative({ width, height, viewBox }) {
  return (
    <svg
...
MenuHambugerIconNegative.defaultProps = {
  width: 56,
  height: 56,
  viewBox: 56,
};

MenuHambugerIconNegative.propTypes = {
  width: PropTypes.number,
  height: PropTypes.number,
  viewBox: PropTypes.number,
};

export default MenuHambugerIconNegative;
